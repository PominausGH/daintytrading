...
<p>At Dainty, before we write a line of code for an AI-powered feature, we run through a decision tree. This helps us choose the right tool for the job. We use this framework for client projects and internal tools alike, whether it’s for <a href="https://telaloom.com/projects/brightpath.html">BrightPath</a>’s user intent classification or <a href="https://telaloom.com/projects/cv-matcher.html">CV Matcher</a>’s qualification logic.</p>
<ol>
...
<li><strong>If LOOSE (hundreds of ms or seconds): Consider LLM.</strong> If the user can wait, or the task runs asynchronously (e.g., background processing for <a href="https://telaloom.com/projects/autoarchive-mail.html">AutoArchive Mail</a>), LLM latency is acceptable.</li>
</ul>
</li>
